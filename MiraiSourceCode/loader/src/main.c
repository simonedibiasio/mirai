...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("192.168.1.9");
#else
    addrs_len = 2;
    addrs = calloc(addrs_len, sizeof (ipv4_t));

    addrs[0] = inet_addr("192.168.1.9"); // Address to bind to
    addrs[1] = inet_addr("192.168.1.9"); // Address to bind to
#endif
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "192.168.1.9", 80, "192.168.1.9")) == NULL)
    {
